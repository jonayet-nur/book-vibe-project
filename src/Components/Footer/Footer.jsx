...
const Footer = () => {
  return (
    <div>
        <footer className="footer sm:footer-horizontal bg-[#b0c5f2dc] text-[#bd7812fc] -content p-8 ">
  <section className=' w-10/12 mx-auto grid grid-cols-3'>
    <nav className='flex flex-col'>
    <h6 className="text-xl font-bold underline ">Services</h6>
  ...
  <nav className='flex flex-col'>
    <h6 className="text-xl font-bold underline">Company</h6>
  ...
  <nav className='flex flex-col'>
    <h6 className=" text-xl font-bold underline">Legal</h6>
  ...
  <footer className="footer footer-horizontal footer-center bg-[#b0c5f2dc] text-[#bd7812fc] p-6">
  <aside>
    <svg
      width="50"
      height="50"
